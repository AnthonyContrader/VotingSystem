...
import com.contrader.service.impl.VotoServiceImpl;
...
/**
 * REST controller for managing {@link com.contrader.domain.Voto}.
 */
@RestController
@RequestMapping("/api")
public class VotoResource {
     ...
     */
    @PostMapping("/votos")
    public ResponseEntity<VotoDTO> createVoto(@Valid @RequestBody VotoDTO votoDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/votos")
    public ResponseEntity<VotoDTO> updateVoto(@Valid @RequestBody VotoDTO votoDTO) throws URISyntaxException {
